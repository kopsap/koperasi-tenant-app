              ...
              children: [
                ...
                SearchFormItem(
                  ...
                  valueWidget: DropdownButton(
                    ...
                    isExpanded: true,
                    items: [
                      DropdownMenuItem(child: Text("Semua"), value: 0),
                      DropdownMenuItem(child: Text("Barang Keluar"), value: 1),
                      DropdownMenuItem(child: Text("Barang Masuk"), value: 2),
                    ],
                    onChanged: (value) {
                      setState(() {
                        localLogType = value!;
                ...
                Expanded(
                  child: PrimaryButton(
                    onPress: () {
                      ...
                      onChange(localStartDt!, localEndDt!, localLogType!);
                      context.pop();
                    },
                    label: "Terapkan",
                  ),
